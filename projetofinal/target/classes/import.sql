...
INSERT INTO AVALIACAO (PARECER, NOTA, DATA_AVALIACAO, PROJETO_ID, AVALIADOR_ID) VALUES ('Ótimo projeto com grande potencial de aplicação prática.', 10.0, '2025-07-01', 1, 1),('Solução inovadora que pode salvar vidas. Recomendo ajustes na ergonomia.', 9.5, '2025-07-03', 2, 2),('Projeto social com excelente impacto ambiental. Merece destaque.', 8.7, '2025-07-05', 3, 1); -- Projeto 4 (Plataforma de Ensino) ficará sem avaliação